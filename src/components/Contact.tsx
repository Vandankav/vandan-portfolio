          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Social Profiles</h4>
            ...
            <div className="mt-10">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Resume</h4>
              <a
                href="/images/VandanKava_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors shadow-md hover:shadow-lg"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-md transition-colors shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                ...
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    className="mt-4 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 p-3 rounded-md"
                  >
                ...
                {submitStatus === 'error' && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 p-3 rounded-md"
                  >
